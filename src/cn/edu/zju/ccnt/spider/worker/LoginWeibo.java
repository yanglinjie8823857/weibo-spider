...
//    					System.out.println("1111  "+pwdName);
    				}
    				// 将隐藏域放入Form
    				...
    				if(input.attr("type").equalsIgnoreCase("hidden")&&input.attr("name").equalsIgnoreCase("capId")){
    					imgurl="http://weibo.cn/interface/f/ttt/captcha/show.php?cpt="+input.attr("value");
    					URL url = new URL(imgurl);  //返回的是4位验证码的图片  
    		...
    		String yzm=s.nextLine();
    		
    		formParams.add(new BasicNameValuePair("code", yzm));
