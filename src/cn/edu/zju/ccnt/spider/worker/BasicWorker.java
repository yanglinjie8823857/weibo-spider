...
//	protected abstract String dataHandler(String url);
	public abstract String dataHandler(String url,CookieStore cookie) throws IOException, Exception;
//	protected abstract String dataHandler(String url,CookieStore cookie,int culevel);
	/**
